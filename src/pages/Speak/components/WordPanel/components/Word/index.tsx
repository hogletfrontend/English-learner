...
import { TypingContext, TypingStateActionType } from '@/pages/Speak/store'
import { currentDictInfoAtom, isIgnoreCaseAtom, isShowAnswerOnHoverAtom, isTextSelectableAtom, pronunciationIsOpenAtom, phoneticConfigAtom } from '@/store'
    ...
    <>
      ...
      <div className="flex flex-col justify-center mt-5">
        ...
        <div className="relative">
          ...
          {/* {currentWord && phoneticConfig.isOpen && <Phonetic word={currentWord} />} */}
